...
import 'package:healthplus/progress_widget.dart';
import 'package:healthplus/rating_start.dart';
...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    TextStyle titleStyle = TextStyles.title.copyWith(fontSize: 25, fontWeight: FontWeight.bold);
    if (AppTheme.fullWidth(context) < 393) {
      titleStyle = TextStyles.title.copyWith(fontSize: 23, fontWeight: FontWeight.bold);
    }
    return Scaffold(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          model.description,
                          style: TextStyles.body.copyWith(color: LightColor.subTitleTextColor),
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            ...
                            FlatButton(
                              ...
                              onPressed: () {},
                              child: Text("Make an appointment", style: TextStyles.titleNormal.copyWith(color: Colors.white),),//.p(10),
                            ),
                          ],
                        )
                      ],
